...
import com.ice.project.mapper.UserMapper;
...
import static com.ice.project.constant.UserConstant.ADMIN_ROLE;
import static com.ice.project.constant.UserConstant.USER_LOGIN_STATE;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User>
    ...
    public long userRegister(String userAccount, String userPassword, String checkPassword) {
        ...
        synchronized (userAccount.intern()) {
            ...
            //规则：使用DigestUtils.md5Hex将盐值和用户账户和5或8位随机数进行MD5加密
